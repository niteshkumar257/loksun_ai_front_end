...
const Excercise = ({ excercise_name,image }) => {
  ...
  return (
    <>
    <div className="relative h-72 w-full shadow-lg  bg-gray-light flex items-center rounded-md justify-center md:w-64 ">
      <span className="absolute top-2 left-2 font-bold z-10 text-lg">{excercise_name}</span>
      <img className="h-72 w-full bg-red-300 object-cover  rounded-md" alt="no image" src={image} />
